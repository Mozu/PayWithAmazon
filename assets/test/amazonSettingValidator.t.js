...
describe('http.commerce.settings.checkout.paymentsettings.updatePaymentSettings.before', function () {

  var action;

  before(function () {
    action = require('../src/domains/commerce.settings/amazonSettingValidator');
  });
